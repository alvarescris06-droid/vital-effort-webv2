...
const App: React.FC = () => {
  ...
  const [modalType, setModalType] = useState<'none' | 'terms' | 'privacy'>(
    'none'
  );
  ...
  const handleVerifyCode = (e: React.FormEvent) => {
    ...
    if (verificationCode === 'VITAL2026') {
      ...
      alert(
        'Código incorrecto. Intenta con VITAL2026 para obtener tu beneficio.'
      );
    }
  };
    ...
    try {
      await fetch('https://formspree.io/f/mbdaqzld', {
        ...
        body: JSON.stringify({
          ...
          Inversion: hasDiscount
            ? selectedPlan!.price * 0.9
            : selectedPlan!.price,
          Moneda: 'COP',
        ...
        <div className="relative bg-[#0d0d0d] border border-white/10 w-full max-w-5xl max-h-[90vh] overflow-hidden rounded-[3rem] flex flex-col shadow-[0_0_50px_rgba(0,0,0,1)] border-t-amber-500/30">
          ...
          <div className="p-8 md:p-10 border-b border-white/5 flex justify-between items-center bg-gradient-to-r from-black to-zinc-900">
            <div className="flex items-center gap-5">
              <div className="w-14 h-14 bg-amber-500 rounded-2xl flex items-center justify-center rotate-3 shadow-lg shadow-amber-500/20">
                {isTerms ? (
                  <Scale className="text-black -rotate-3" size={30} />
                ) : (
                  <ShieldCheck className="text-black -rotate-3" size={30} />
                )}
              </div>
              <div>
                <h2 className="text-3xl md:text-4xl font-[1000] uppercase italic tracking-tighter leading-none">
                  ...
                  <span className="text-amber-500">
                    {isTerms ? 'Condiciones' : 'Privacidad'}
                  </span>
                </h2>
              </div>
            </div>
              ...
              {isTerms ? (
                <>
                  <section className="space-y-4">
                    <h3 className="text-xl font-black text-amber-500 italic uppercase tracking-widest border-l-4 border-amber-500 pl-4">
                      RIESGO DEL USO DEL PRODUCTO
                    </h3>
                    <div className="text-gray-300 space-y-4 leading-relaxed font-medium">
                      <p>
                        El contenido de este sitio web no reemplaza la atención
                        y el diagnóstico médico directo, personal y profesional.
                        Ninguno de los planes de comidas o programas de
                        ejercicios debe realizarse o usarse sin la autorización
                        previa de su médico o proveedor de atención médica. La
                        información contenida en el mismo no pretende
                        proporcionar consejos específicos de salud física o
                        mental, ni ningún otro tipo de consejo, para ningún
                        individuo o empresa y no debe confiarse en ese sentido.
                        No somos profesionales médicos y nada en este sitio web
                        debe malinterpretarse en el sentido de lo contrario.
                      </p>
                      <p>
                        Puede haber riesgos asociados con la participación en
                        las actividades mencionadas en nuestro sitio para
                        personas con mala salud o con condiciones de salud
                        física o mental preexistentes. Debido a que existen
                        estos riesgos, no participará en ningún plan de comidas
                        que le ofrezcamos si tiene problemas de salud o tiene
                        una condición mental o física preexistente. Si elige
                        participar en estos riesgos, lo hace por su propia
                        voluntad y acuerdo, asumiendo consciente y
                        voluntariamente todos los riesgos asociados con tales
                        actividades dietéticas. Estos riesgos también pueden
                        existir para aquellos que actualmente gozan de buena
                        salud.
                      </p>
                      <p>
                        Como con cualquier programa de ejercicios, usted asume
                        ciertos riesgos para su salud y seguridad. Cualquier
                        forma de programa de ejercicios puede causar lesiones, y
                        nuestros programas no son una excepción. Es posible que
                        te lesiones haciendo los ejercicios de tu programa,
                        especialmente si los haces de forma deficiente. Aunque
                        se incluye una instrucción completa en el formulario
                        para cada ejercicio.
                      </p>
                      <p>
                        Tenga en cuenta que nuestros programas (como cualquier
                        otro programa de ejercicios) implican un riesgo de
                        lesiones. Si elige participar en estos riesgos, lo hace
                        por su propia voluntad y acuerdo, asumiendo consciente y
                        voluntariamente todos los riesgos asociados con dichas
                        actividades de ejercicio. Estos riesgos también pueden
                        existir para aquellos que actualmente gozan de buena
                        salud.
                      </p>
                      <p>
                        No somos médicos. Nuestros consejos, ya sea en nuestro
                        sitio web, en nuestros planes de comidas, programas de
                        ejercicios o mediante entrenamiento por correo
                        electrónico, no pretenden sustituir el consejo médico.
                        Debe consultar a su médico antes de comenzar CUALQUIER
                        plan de comidas o programa de ejercicios, sin
                        excepciones. Está utilizando nuestros planes, programas,
                        entrenamientos y entrenamiento bajo su propio riesgo y
                        no somos responsables de ninguna lesión o problema de
                        salud que pueda experimentar o incluso la muerte como
                        resultado del uso de nuestros programas.
                      </p>
                      <p className="text-white font-bold italic bg-white/5 p-4 rounded-xl border-l-4 border-white">
                        Es de aclarar que nosotros no somos responsables de
                        ningún tipo de lesiones o problemas de salud que puedas
                        experimentar, o incluso la muerte por el resultado de
                        usar uno de nuestros productos o servicios.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="space-y-4">
                    <h3 className="text-xl font-black text-amber-500 italic uppercase tracking-widest border-l-4 border-amber-500 pl-4">
                      RESULTADOS GENERALMENTE ESPERADOS
                    </h3>
                    <div className="text-gray-300 space-y-4 leading-relaxed">
                      <p>
                        Aunque nuestros productos y servicios están destinados a
                        implementarse por completo, a veces no lo son, lo que
                        podría resultar en una falta de progreso/resultados para
                        el usuario. Si implementa nuestros productos y servicios
                        correctamente, debería ver resultados asombrosos, sin
                        embargo, debe negarse que incluso cuando los
                        consumidores implementen completamente cualquier
                        producto o servicio de nosotros, es posible que no
                        obtengan los resultados que esperaban y también es
                        posible que no pierdan grasa ni ganen músculo ni logren
                  ...
                  <section className="space-y-4">
                    <h3 className="text-xl font-black text-amber-500 italic uppercase tracking-widest border-l-4 border-amber-500 pl-4">
                      TESTIMONIO DE DESCARGO DE RESPONSABILIDAD
                    </h3>
                    <div className="text-gray-300 space-y-4 leading-relaxed">
                      <p>
                        Todas las transformaciones y testimonios son reales. Sin
                        embargo, debe negarse que estos testimonios no pretenden
                        representar resultados típicos con nuestros planes de
                        comidas y programas de entrenamiento. Están pensados
                        como un escaparate de lo que las personas más motivadas
                        y dedicadas pueden lograr siguiendo nuestros planes de
                        comidas y programas de entrenamiento personalizados. Sus
                        resultados pueden variar y es posible que no obtenga los
                        mismos resultados en comparación con otra persona al
                        usar nuestros servicios debido a las diferencias en su
                        historial de ejercicio individual, genética y
                        motivación/dedicación personal. Los resultados finales
                        que obtenga dependerán de la persona y del esfuerzo que
                        ponga.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="space-y-4">
                    <h3 className="text-xl font-black text-amber-500 italic uppercase tracking-widest border-l-4 border-amber-500 pl-4">
                      INFORMACIÓN IMPORTANTE DE FACTURACIÓN
                    </h3>
                    <div className="text-gray-300 space-y-4 leading-relaxed">
                      <p>
                        Si adquieres nuestro Programa, serás automáticamente
                        cargado cada periodo y vas a continuar recibiendo nuevas
                        actualizaciones de los planes de comidas y de los
                        programas de entrenamiento por el tiempo que hayas
                        escogido permanecer como cliente.
                      </p>
                      <p>
                        Con todos nuestros Servicios En Línea tenemos una opción
                        de reembolso del 100% del dinero abonado de 14 días - Si
                        en los próximos 14 días de tu compra inicial no te
                        sientes feliz o satisfecho con alguna de tus compras con
                        nosotros (servicio de suscripción o sin suscripción) por
                        cualquier razón, simplemente solicita un reembolso
                        completo contactando al Equipo de Ayuda al Cliente.
                        Serás reembolsado y tu suscripción será cancelada. Sin
                        embargo, si compras el programa durante un periodo
                        promocional y has redimido esa promoción (ej.
                        suplementos, ropa, audífonos) no eres elegible para un
                        reembolso.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="space-y-4">
                    <h3 className="text-xl font-black text-amber-500 italic uppercase tracking-widest border-l-4 border-amber-500 pl-4">
                      CANCELACIÓN DE TU SUSCRIPCIÓN
                    </h3>
                    <div className="text-gray-300 space-y-4 leading-relaxed">
                      <p>
                        Puedes cancelar tu suscripción en cualquier momento, sin
                        embargo sujeta a 7 días de aviso previo. En orden de
                        cancelar tu suscripción simplemente envía un correo
                        electrónico a soporte. Si tienes alguna pregunta, por
                        favor envíanos un mensaje al correo. Puedes contactar al
                        Equipo de Ayuda al Cliente por vital.effort06@gmail.com
                        y estaremos más que felices por responder cualquiera de
                        tus preguntas.
                      </p>
                    </div>
                  </section>
                ...
                <>
                  <section className="space-y-4">
                    ...
                    <div className="text-gray-300 space-y-4 leading-relaxed">
                      <p>
                        Estamos totalmente comprometidos con la protección de la
                        privacidad de los visitantes y clientes de nuestro
                        sitio, apreciamos y respetamos plenamente la importancia
                        de la privacidad en Internet. No divulgaremos
                        información sobre nuestros clientes a terceros, excepto
                        en el caso de que sea parte de un servicio para usted,
                        por ejemplo. organizar el envío de un producto, realizar
                        comprobaciones de crédito y otros controles de
                        seguridad. Para fines de investigación y creación de
                        perfiles de los clientes, o cuando tengamos su permiso
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="text-gray-300 space-y-4 leading-relaxed">
                      <p>
                        No venderemos su nombre, dirección, dirección de correo
                        electrónico, información de su tarjeta de crédito o
                        información personal a ningún tercero (excluyendo a los
                        socios a los que usted pueda haber vinculado a nuestro
                        sitio) sin su permiso.
                      </p>
                      <p className="font-bold text-white uppercase italic underline decoration-amber-500">
                        COMUNICACIÓN Y MARKETING:
                      </p>
                      <p>
                        Si ha realizado una compra en mi tienda, es posible que
                        ocasionalmente le envíe actualizaciones de nuestros
                        nuevos productos, noticias y ofertas especiales por
                        correo electrónico. Todos nuestros clientes tienen la
                        opción de optar por no recibir comunicaciones de
                        marketing de parte mía y / o terceros seleccionados. Si
                        no desea continuar recibiendo promociones de mi parte y
                        / o de terceros seleccionados al finalizar la compra.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="text-gray-300 space-y-4 leading-relaxed font-medium">
                      <p>
                        Una cookie es un pequeño archivo de información que se
                        envía a su computadora y se almacena en su disco duro.
                        Si se ha registrado con nosotros, su computadora
                        almacenará una cookie de identificación que le ahorrará
                        tiempo cada vez que vuelva a visitar nuestro sitio, al
                        recordar su dirección de correo electrónico. Puede
                        cambiar la configuración de su navegador para evitar que
                        las cookies se almacenen en su computadora sin su
                      ...
                      <p>
                        Este sitio web utiliza el servicio de remarketing de
                        Google AdWords para anunciarse en sitios web de terceros
                        (incluido Google) a los visitantes anteriores de nuestro
                        sitio. Podría significar que anunciamos a visitantes
                        anteriores que no completaron una tarea en nuestro
                        sitio, por ejemplo, utilizando el formulario de contacto
                        para realizar una consulta. Los proveedores de terceros,
                        incluido Google, usan cookies para publicar anuncios
                        basados en las visitas anteriores de alguien a nuestro
                        sitio. Por supuesto, cualquier información recopilada se
                        usará de acuerdo con nuestra propia política de
                        privacidad y la política de privacidad de Google.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="space-y-4">
                    <h3 className="text-xl font-black text-amber-500 italic uppercase tracking-widest border-l-4 border-amber-500 pl-4">
                      VERIFICANDO TUS DETALLES Y CONTACTO
                    </h3>
                    <div className="text-gray-300 space-y-4 leading-relaxed">
                      <p>
                        Nuestros procedimientos de seguridad significan que
                        podemos solicitar una prueba de identidad antes de
                        revelar información. Esta prueba de identidad se basará
                        en su dirección de correo electrónico y contraseña
                        enviada al registrarse. Recomendamos encarecidamente que
                        no utilice la función de memoria de contraseña del
                        navegador.
                      </p>
                      <div className="bg-amber-500/10 p-6 rounded-2xl border border-amber-500/20 mt-8">
                        <p className="text-white font-black uppercase italic mb-2 text-center">
                          CONTACTENOS
                        </p>
          ...
          <div className="p-8 border-t border-white/5 bg-black flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-[10px] text-gray-500 font-black uppercase tracking-[0.3em]">
              Vital Effort • High Performance System
            </p>
            <button
              onClick={() => setModalType('none')}
        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-zinc-900 via-black to-black">
          <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[3.5rem] w-full max-w-[450px] space-y-8 shadow-2xl animate-in fade-in zoom-in duration-500">
            <div className="text-center space-y-3">
              ...
              <h2 className="text-4xl font-[1000] uppercase italic tracking-tighter mt-6">
                Área VIP
              </h2>
              <p className="text-gray-400 text-[10px] font-black uppercase tracking-[0.2em]">
                {authStep === 'form'
                  ? 'Ingresa a la comunidad Vital Effort'
            ...
            {authStep === 'form' ? (
              <form onSubmit={handleAuthSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-500 text-black py-5 rounded-2xl font-[1000] uppercase italic hover:bg-amber-400 transition-all shadow-xl shadow-amber-500/20"
                >
                  {isRegistering
                    ? 'Registrarme y obtener 10% OFF'
                    : 'Iniciar Sesión'}
                </button>
                <button
                  type="button"
                ...
                >
                  {isRegistering
                    ...
                    : '¿Eres nuevo? Regístrate para un 10% OFF'}
                </button>
              </form>
            ) : (
              <form onSubmit={handleVerifyCode} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-green-500 text-black py-5 rounded-2xl font-[1000] uppercase italic hover:bg-green-400 transition-all shadow-lg shadow-green-500/20"
                >
                  Verificar Código
                </button>
              </form>
        ...
        <>
            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center">
              ...
              >
                ...
                <div className="flex flex-col justify-center border-l-2 border-amber-500/30 pl-4 md:pl-6 text-left">
                  ...
                  <p className="text-amber-500/60 text-[10px] md:text-xs font-black tracking-[0.3em] uppercase mt-1">
                    High Performance
                  </p>
                </div>
              </div>
          ...
          {view === 'landing' ? (
            <>
              <header className="py-28 px-6 text-center border-b border-white/5 overflow-hidden relative">
                ...
                <div className="max-w-5xl mx-auto">
                  ...
                  <p className="text-xl md:text-3xl text-gray-500 max-w-3xl mx-auto mb-16 leading-relaxed font-medium">
                    Entrena con propósito, vive con disciplina y Evoluciona con
                    ciencia. Programas de alto rendimiento diseñados para
                    transformar tu biologia.
                  </p>
              ...
              <div className="bg-amber-500 py-10 overflow-hidden">
                <div className="animate-marquee">
                  {[...Array(20)].map((_, i) => (
                    <span
                      key={i}
                      className="text-black font-[1000] italic text-4xl uppercase tracking-tighter mx-10 flex items-center gap-6"
                    >
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                  <div className="text-center mb-24">
                    ...
                    <p className="text-gray-500 font-bold uppercase tracking-[0.3em] text-sm">
                      Elige el nivel de tu evolución
                    </p>
                  ...
                  <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        {[
                          {
                            ...
                            d: 'Mensualidad incluida para clases presenciales, no aplican clases online.',
                          },
                          {
                            t: 'Nutrición Inteligente',
                            d: 'Plan basado en tu estado nutricional.',
                          },
                          {
                            t: 'Entrenamiento a Medida',
                            d: 'Basado en tus objetivos y nivel actual.',
                          },
                          {
                            t: 'Acompañamiento',
                            d: 'Chat directo para dudas y ajustes.',
                          },
                          {
                            t: 'Análisis de Progreso',
                            d: 'Revisiones mensuales de métricas.',
                          },
                        ].map((item, i) => (
                          <li
                            key={i}
                          ...
                          >
                            ...
                            <span className="text-gray-400">
                              <strong className="text-white uppercase italic block mb-1">
                                {item.t}:
                              </strong>
                              {item.d}
                            </span>
                    ...
                    <div className="bg-[#151515] p-12 rounded-[3.5rem] border-2 border-amber-500 flex flex-col relative transform lg:scale-105 shadow-[0_0_60px_rgba(245,158,11,0.15)] group">
                      ...
                      <ul className="space-y-6 mb-16 flex-grow">
                        {[
                          {
                            t: 'TODO LO DEL MENSUAL',
                            d: 'Todos los beneficios estándar incluidos.',
                          },
                          {
                            t: 'Rehabilitación Física',
                            d: 'Especializado para prevenir lesiones.',
                          },
                          {
                            t: 'Suplementación',
                            d: 'Guía basada en evidencia cientifica.',
                          },
                          {
                            t: 'Acceso Prioritario',
                            d: 'Respuesta inmediata por WhatsApp.',
                          },
                        ].map((item, i) => (
                          <li
                            key={i}
                    ...
                    <div className="bg-[#111] p-12 rounded-[3.5rem] border border-white/5 flex flex-col hover:border-amber-500/30 transition-all group">
                      ...
                      <ul className="space-y-6 mb-16 flex-grow">
                        {[
                          ...
                          {
                            t: 'Ahorro Máximo',
                            d: 'Obtienes 3 meses gratis comparado al mensual.',
                          },
                          {
                            t: 'Masterclass VIP',
                            d: 'Acceso a contenido exclusivo anual.',
                          },
                          {
              ...
              <section
                id="servicios"
                className="py-32 px-6 bg-black relative border-t border-white/5"
              >
                <div className="max-w-7xl mx-auto relative z-10">
                  <div className="text-center mb-24">
                    <h3 className="text-4xl md:text-7xl font-[1000] italic uppercase tracking-tighter mb-4">
                      SERVICIOS{' '}
                      <span className="text-amber-500">VITAL EFFORT</span>
                    </h3>
                    <p className="text-gray-500 font-bold uppercase tracking-[0.3em] text-sm">
                      Precisión científica en cada variable
                    </p>
                    <div className="h-1.5 w-48 bg-amber-500 mx-auto mt-8 rounded-full"></div>
                  </div>
...
<div className="bg-[#111] p-10 rounded-[3.5rem] border border-white/5 flex flex-col hover:border-amber-500/30 transition-all group h-full">
  ...
  <button onClick={() => handlePlanSelection('Vital Training', 100)} className="w-full py-5 bg-white/5 text-white font-[1000] rounded-2xl uppercase tracking-widest hover:bg-amber-500 hover:text-black transition-all border border-white/10">Adquirir Entrenamiento</button>
              ...
              <section className="py-40 bg-white text-black px-6">
                <div className="max-w-6xl mx-auto text-center">
                  <div className="flex justify-center gap-4 mb-10">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} fill="black" size={30} />
                    ))}
                  </div>
                  <h3 className="text-4xl md:text-7xl font-[1000] uppercase italic tracking-tighter leading-tight mb-12">
                    "NO ENTRENAMOS PARA VERNOS BIEN, ENTRENAMOS PARA SER{' '}
                    <span className="underline decoration-amber-500 decoration-8">
                  ...
                  <div className="flex items-center justify-center gap-6">
                    ...
                    <p className="font-black uppercase tracking-[0.4em] text-xl">
                      Vital Effort Team
                    </p>
                    <div className="h-0.5 w-16 bg-black"></div>
                  </div>
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="text-center mb-16">
                    <h3 className="text-4xl md:text-6xl font-[1000] uppercase italic tracking-tighter mb-4">
                      PREGUNTAS{' '}
                      <span className="text-amber-500">FRECUENTES</span>
                    </h3>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        key={index}
                        className="border border-white/5 rounded-3xl overflow-hidden bg-[#111] transition-all duration-300"
                      >
                        <button
                          onClick={() =>
                        ...
                        >
                          <span className="font-bold uppercase italic tracking-tight text-lg pr-4">
                            {item.q}
                          </span>
                          <ChevronRight
                            size={24}
              ...
              <footer
                id="contacto"
                className="bg-black py-32 px-6 border-t-4 border-amber-500"
              >
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="space-y-12">
                      <div className="flex items-center gap-8 group">
                        <img
                          src={logoPath}
                          alt="Logo"
                          className="h-48 md:h-64 w-auto grayscale transition-all group-hover:grayscale-0"
                        />
                      ...
                      <p className="text-gray-500 text-xl font-medium leading-relaxed max-w-lg">
                        Únete a los cientos de atletas que han dejado de
                        adivinar y han empezado a evolucionar con un sistema
                        real.
                      </p>
                    </div>

                    <div className="space-y-6">
                      <h4 className="text-2xl font-[1000] uppercase italic mb-8 tracking-widest">
                        Canales Oficiales
                      </h4>
                  ...
                  <div className="mt-32 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
                    <p className="text-gray-800 text-sm font-black tracking-[1em]">
                      © 2026 VITAL EFFORT
                    </p>
              ...
              <div className="grid lg:grid-cols-12 gap-12">
                <div className="lg:col-span-7 space-y-12">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-amber-500 rounded-full flex items-center justify-center text-black font-[1000] text-xl italic">
                      01
                    </div>
                    <h2 className="text-4xl font-[1000] uppercase italic tracking-tighter">
                      MIS <span className="text-amber-500">DATOS</span>
                    </h2>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-6">
                    ...
                    <h2 className="text-4xl font-[1000] uppercase italic tracking-tighter">
                      MÉTODO DE <span className="text-amber-500">PAGO</span>
                    </h2>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    >
                      ...
                      <div>
                        <span className="block font-[1000] uppercase italic text-xl">
                          Tarjeta / PSE / Nequi
                        </span>
                        <span className="text-[10px] text-gray-500 font-black uppercase tracking-widest mt-1 block">
                          Procesado por Mercado Pago Seguro
                        </span>
                      </div>
                    </button>
                  </div>
                  ...
                  {paymentMethod === 'card' && (
                    <div className="bg-[#111] border border-white/10 p-8 rounded-[2.5rem] space-y-6 animate-in fade-in zoom-in-95 duration-300">
                      <div className="flex items-center gap-4 border-b border-white/5 pb-4 text-amber-500">
                        <ShieldCheck size={30} />
                        <h4 className="font-[1000] uppercase italic text-xl">
                          Pago Seguro en Colombia
                        </h4>
                      </div>
                      <div className="space-y-6">
                        <div className="space-y-2">
                          <p className="text-gray-400 text-sm font-medium leading-relaxed">
                            Serás redirigido a la pasarela oficial de{' '}
                          ...
                          <div className="flex flex-wrap gap-2 py-2">
                            <span className="bg-white/5 text-[10px] px-3 py-1 rounded-full text-gray-400 border border-white/10 font-bold">
                              PSE (NEQUI/DAVIPLATA)
                            </span>
                            <span className="bg-white/5 text-[10px] px-3 py-1 rounded-full text-gray-400 border border-white/10 font-bold">
                        ...
                        <p className="text-[10px] text-center text-gray-500 font-bold uppercase tracking-widest">
                          ...
                          Transacción protegida por Mercado Pago Colombia
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <div className="lg:col-span-5 space-y-8">
                  ...
                  <div className="bg-[#111] p-10 rounded-[3.5rem] border border-white/5 sticky top-32 space-y-8">
                    <div className="space-y-4">
                      <h4 className="text-gray-500 font-black uppercase tracking-widest text-xs">
                        Plan Seleccionado:
                      </h4>
                      <div className="flex justify-between items-end">
                        <span className="text-3xl font-[1000] uppercase italic">
                          {selectedPlan?.name}
                        </span>
                        <span className="text-amber-500 font-[1000] text-2xl">
                    ...
                    {hasDiscount && (
                      <div className="bg-green-500/10 border border-green-500/20 p-4 rounded-2xl flex justify-between items-center">
                        <span className="text-green-500 font-black uppercase text-[10px] tracking-tighter">
          ...
          {paymentSuccess && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md animate-in fade-in duration-500">
              <div className="bg-[#111] border border-amber-500/30 p-10 rounded-[3rem] max-w-md w-full text-center space-y-6 shadow-2xl shadow-amber-500/20 border-t-amber-500">
                ...
                <div className="space-y-2">
                  <h3 className="text-3xl font-[1000] uppercase italic text-white tracking-tighter">
                    ¡CUPÓ RESERVADO!
                  </h3>
                ...
                <p className="text-gray-400 font-medium italic text-sm leading-relaxed">
                  Estamos conectando con la pasarela oficial de{' '}
                  <span className="text-white font-bold">
                    Mercado Pago Colombia
                  </span>{' '}
                  para finalizar tu inscripción de forma segura.
                </p>
          ...
          {isVerified && (
            <div className="fixed inset-0 z-[1000000] flex items-center justify-center p-6 bg-black animate-in fade-in duration-1000">
              <div className="max-w-md w-full text-center space-y-10 animate-in zoom-in duration-700">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-400 font-medium italic text-lg leading-tight">
                    Tu acceso ha sido verificado. El Coach te espera para
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div className="space-y-4">
                    <p className="text-sm text-gray-300 font-medium leading-relaxed">
                      Utilizamos tecnología para mejorar tu experiencia y
                      asegurar que tu evolución sea rastreable.
                    </p>
                    <button
                      onClick={() => {
...
{
  /* --- COMPONENTE INDEPENDIENTE: CALCULADORA METABÓLICA --- */
}
const MetabolicCalculator = () => {
  ...
  const calculate = () => {
    ...
    const tdee = tmb * Number(activity);
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h3 className="text-3xl md:text-5xl font-[1000] italic uppercase tracking-tighter mb-4">
            ANÁLISIS <span className="text-amber-500">METABÓLICO</span>
          </h3>
          <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">
            Determina tu punto de partida científico
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-12 items-start">
          {/* Inputs */}
          <div className="space-y-6 bg-[#111] p-8 rounded-[2.5rem] border border-white/10">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-black uppercase text-gray-500 mb-2 ml-2">
                  Género
                </label>
                <select
                  onChange={(e) => setData({ ...data, gender: e.target.value })}
                  className="w-full bg-black border border-white/10 rounded-xl p-3 text-white text-sm outline-none focus:border-amber-500 transition-colors"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black border border-white/10 rounded-xl p-3 text-white text-sm outline-none focus:border-amber-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="1.9">Atleta (2 entrenos/día)</option>
              </select>
            </div>

            <button
              onClick={calculate}
              className="w-full py-4 bg-amber-500 text-black font-[1000] rounded-xl uppercase tracking-widest hover:bg-white transition-all text-xs"
            >
          ...
          <div className="h-full">
            {result ? (
              <div className="bg-amber-500 p-8 rounded-[2.5rem] text-black h-full flex flex-col justify-center animate-in fade-in zoom-in duration-500">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] mb-2 opacity-70">
                  Tu Gasto Energético Total (TDEE)
                </p>
                <h4 className="text-6xl font-[1000] italic mb-6">
                  {result.tdee}{' '}
                  <span className="text-2xl not-italic font-bold">kcal</span>
                </h4>
                ...
                <div className="space-y-4 border-t border-black/10 pt-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold">{result.tmb} kcal</span>
                  </div>
                  <div className="p-4 bg-black/5 rounded-2xl">
                    <p className="text-[11px] leading-relaxed">
                      Este es el combustible que tu cuerpo quema para mantenerse
                      vivo. Para <strong>ganar músculo</strong> o{' '}
                      <strong>perder grasa</strong>, necesitamos ajustar estos
                      números con precisión biomecánica.
                    </p>
                  </div>
                </div>
              </div>
            ) : (
              <div className="border-2 border-dashed border-white/10 h-full rounded-[2.5rem] flex items-center justify-center p-12 text-center">
                <p className="text-gray-600 text-xs uppercase font-bold tracking-widest">
